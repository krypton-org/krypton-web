...
class TodoComponent extends Component<Props> {
    ...
    render() {
        ...
        return (
            <tr>
                <td style={{ verticalAlign: "middle" }}><a className="delete" onClick={this.handleClose}></a></td>
                <td style={{ verticalAlign: "middle" }}>{this.props.data.text}</td>
                <td style={{ verticalAlign: "middle" }}><TimeAgo date={date} /></td>
                <td className="has-text-centered" style={{ verticalAlign: "middle" }}>
                    {!this.props.data.isCompleted ?
                        <button className="button is-info is-outlined is-small" onClick={this.handleCompleted}>Task completed</button>
                        :
