            ...
            <div>
                ...
                <Form onSubmit={this.handleSubmit}>
                    <div className="columns">
                        ...
                        <div className="column">
                            {!this.state.isEditionModeEnabled &&
                                <button className="button" type="button" onClick={this.handleEdit}>Edit</button>
                            }
                            {this.state.isEditionModeEnabled &&
                                <div>
                                    <button className={submitClass} disabled={isDisabled} style={{ marginRight: '5px' }}>Submit</button>
                                    <button className="button" type="button" onClick={this.handleCancelEdit}>Cancel</button>
                                </div>
                            }
                        </div>
                    </div>
