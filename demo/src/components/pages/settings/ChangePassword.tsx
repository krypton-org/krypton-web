...
class ChangePassword extends Component<Props, State> {
    ...
    handleNewPasswordChange = (event: React.ChangeEvent<HTMLInputElement>): void => {
        this.setState({ ...this.state, newPassword: event.target.value, isPasswordValid: isPasswordValid(event.target.value) })
    };
            ...
            <div>
                ...
                <Form autoComplete="off" onSubmit={this.handleSubmit}>
                    <div className="columns">
                        ...
                        <div className="column">
                            <button className={submitClass} disabled={isDisabled}>Submit</button>
                        </div>
                    </div>
                </Form>
            </div>
